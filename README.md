...
[https://docs.ultralytics.com/quickstart/#install-ultralytics](https://docs.ultralytics.com/quickstart/#install-ultralytics)
...
[https://lanyun.net/term.html](https://lanyun.net/term.html)

注册登录后，现在会送50元代金券，可以用来搭建训练服务器

云训练环境搭建教程，yolov5版本，这个版本可以在大漠工具中使用，方便测试效果

[https://docs.ultralytics.com/zh/yolov5/environments/aws_quickstart_tutorial/#step-3-connect-to-your-instance](https://docs.ultralytics.com/zh/yolov5/environments/aws_quickstart_tutorial/#step-3-connect-to-your-instance)
...
1 [YOLOv8 Github地址](https://github.com/ultralytics/ultralytics)
...
//coco数据集
yolo detect train data=/home/lime/AI/yolo/yolov10/datasets/coco128/coco128.yaml model=yolov10s.yaml epochs=2000  imgsz=640 device=0 batch=32

//打地鼠数据集
yolo detect train data=/home/lime/AI/yolo/yolov10/datasets/dadishu/dadishu.yaml model=yolov10s.yaml epochs=2000  imgsz=640 device=0 batch=32
...
1 [YOLOv11 Github地址](https://github.com/ultralytics/ultralytics)
...
rm -rfv /home/lime/AI/yolo/yolov11/ultralytics/runs

//coco数据集
yolo train data=/home/lime/AI/yolo/yolov11/datasets/coco128/coco128.yaml model=/home/lime/AI/yolo/yolov11/datasets/yolo11s.pt epochs=2000  imgsz=640 device=0 batch=32

//打地鼠数据集
yolo train data=/home/lime/AI/yolo/yolov11/datasets/dadishu/dadishu.yaml model=/home/lime/AI/yolo/yolov11/datasets/yolo11s.pt epochs=2000  imgsz=640 device=0 batch=32
...
```shell
//coco数据集
yolo predict model=runs/detect/train/weights/best.pt data=/home/lime/AI/yolo/yolov11/datasets/coco128/coco128.yaml source=/home/lime/AI/yolo/yolov11/datasets/coco128/images/train2017 batch=32


//打地鼠数据集
yolo predict model=runs/detect/train/weights/best.pt data=/home/lime/AI/yolo/yolov11/datasets/dadishu/dadishu.yaml source=/home/lime/AI/yolo/yolov11/datasets/dadishu/images/ batch=32
...
```shell
//coco数据集
yolo val model=runs/detect/train/weights/best.pt data=/home/lime/AI/yolo/yolov11/datasets/coco128/coco128.yaml batch=32

//打地鼠数据集
yolo val model=runs/detect/train/weights/best.pt data=/home/lime/AI/yolo/yolov11/datasets/dadishu/dadishu.yaml batch=32
